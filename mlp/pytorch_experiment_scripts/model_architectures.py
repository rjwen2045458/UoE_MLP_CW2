...
class ConvolutionalProcessingBlock_Res(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_Res, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_Res(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_Res, self).__init__()
